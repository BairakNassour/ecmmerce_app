...
class VerfiedCodeSignUp extends StatelessWidget {
  const VerfiedCodeSignUp({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    OtpFieldController otpController = OtpFieldController();
    VerfiyCodeSignUpControllerImpl controller=Get.put(VerfiyCodeSignUpControllerImpl());
    return Scaffold(
      appBar: AppBar(
